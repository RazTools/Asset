    ...
    public class ZZZ : Format
    {
        ...
        protected override (string, string)[] CollectPaths(string input, string output, bool isEncrypt)
        {
            ...
            foreach (var file in files)
            {
                ...
                relativePath = isEncrypt ? Path.ChangeExtension(relativePath, Extension.Item2) : Path.Combine(Path.GetDirectoryName(relativePath), Path.GetFileNameWithoutExtension(relativePath) + Extension.Item1);
